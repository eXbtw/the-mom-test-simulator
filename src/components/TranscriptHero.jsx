...
export default function TranscriptHero() {
  return (
    <div className="group relative mx-auto w-full max-w-sm -rotate-1 transition-transform duration-300 ease-out hover:rotate-0 motion-reduce:transform-none">
      ...
      <div className="rounded-lg border border-[#DDD2B0] bg-[#FFFCF5] px-5 py-5 shadow-[0_14px_28px_-14px_rgba(0,0,0,0.35)] transition-shadow duration-300 group-hover:shadow-[0_18px_34px_-14px_rgba(0,0,0,0.4)] dark:border-gray-700 dark:bg-gray-800 dark:shadow-none">
        <p className="font-display text-[13px] uppercase tracking-widest text-[#B4A888] dark:text-gray-500">
          Из интервью
        </p>
        <p className="mt-2 font-display text-[15px] leading-relaxed text-[#8A8065] line-through decoration-[#C6402F] decoration-2 dark:text-gray-500 dark:decoration-[#FF5A42]">
          «А вы бы купили такую страховку?»
        </p>
        <p className="mt-2 font-hand text-2xl leading-snug text-[#C6402F] dark:text-[#FF5A42]">
